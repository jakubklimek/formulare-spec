...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="2.0" xmlns:osoby="https://ofn.gov.cz/společné-části-elektronických-dokumentů/2024-10-04/osoby" xmlns:c="https://schemas.dataspecer.com/xsd/core/" xmlns:místa="https://ofn.gov.cz/společné-části-elektronických-dokumentů/2024-10-04/místa" xmlns:ns0="https://slovník.gov.cz/legislativní/sbírka/89/2012/pojem/" xmlns:ns1="https://slovník.gov.cz/generický/eu-1501-2015-e-idas-prováděcí/pojem/" xmlns:ns2="https://slovník.gov.cz/generický/standard-pro-elektronické-dokumenty/pojem/">
  ...
  <xsl:template name="_https_003a_002f_002fofn.gov.cz_002fclass_002f1727280250648-5253-44c4-a1e6">
    ...
    <rdf:Description>
      ...
      <xsl:for-each select="osoby:současná_jména">
        <ns1:současné-jméno-jména rdf:datatype="http://www.w3.org/2001/XMLSchema#string">
          <xsl:apply-templates select="@*"/>
          <xsl:value-of select="."/>
        </ns1:současné-jméno-jména>
      </xsl:for-each>
      <xsl:for-each select="osoby:současná_příjmení">
        <ns1:současné-příjmení rdf:datatype="http://www.w3.org/2001/XMLSchema#string">
          <xsl:apply-templates select="@*"/>
          <xsl:value-of select="."/>
        </ns1:současné-příjmení>
      </xsl:for-each>
